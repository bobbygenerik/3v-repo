                ...
                callLogs.forEach { log ->
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                Text("$direction call to ${log["calleeId"]}", style = MaterialTheme.typography.bodyLarge, color = color)
                                Text("Started: $dateStr", style = MaterialTheme.typography.bodySmall)
                                Text("Duration: $duration sec", style = MaterialTheme.typography.bodySmall)
                            }
                        }
                    }
                }
