...
describe('ContextManager', () => {
    ...
    describe('loadEnvironmentMemory', () => {
        it('should load and format environment memory', async () => {
            ...
            vi.mocked(memoryDiscovery.loadEnvironmentMemory).mockResolvedValue(mockResult);
            const mockExtensionLoader = {};
            const result = await contextManager.loadEnvironmentMemory(['/app'], mockExtensionLoader);
            expect(memoryDiscovery.loadEnvironmentMemory).toHaveBeenCalledWith(['/app'], mockExtensionLoader, false);
