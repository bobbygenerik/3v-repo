 ...
 * extensionConfig.
 */
function extensionConsentString(extensionConfig, hasHooks) {
 ...
 */
export async function maybeRequestConsentOrFail(extensionConfig, requestConsent, hasHooks, previousExtensionConfig, previousHasHooks) {
    const extensionConsent = extensionConsentString(extensionConfig, hasHooks);
    if (previousExtensionConfig) {
        const previousExtensionConsent = extensionConsentString(previousExtensionConfig, previousHasHooks ?? false);
