...
import { DEFAULT_GEMINI_FLASH_LITE_MODEL, DEFAULT_GEMINI_FLASH_MODEL, DEFAULT_GEMINI_MODEL, PREVIEW_GEMINI_MODEL, } from '@google/gemini-cli-core';
...
const ModelUsageTable = ({ models, quotas, cacheEfficiency, totalCachedTokens }) => {
    ...
    return (_jsxs(Box, { flexDirection: "column", marginTop: 1, children: [_jsxs(Box, { alignItems: "flex-end", children: [_jsx(Box, { width: nameWidth, flexGrow: 1, children: _jsx(Text, { bold: true, color: theme.text.primary, wrap: "truncate-end", children: "Model Usage" }) }), _jsx(Box, { width: requestsWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { bold: true, color: theme.text.primary, children: "Reqs" }) }), !showQuotaColumn && (_jsxs(_Fragment, { children: [_jsx(Box, { width: uncachedWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { bold: true, color: theme.text.primary, children: "Input Tokens" }) }), _jsx(Box, { width: cachedWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { bold: true, color: theme.text.primary, children: "Cache Reads" }) }), _jsx(Box, { width: outputTokensWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { bold: true, color: theme.text.primary, children: "Output Tokens" }) })] })), showQuotaColumn && (_jsx(Box, { width: usageLimitWidth, flexDirection: "column", alignItems: "flex-end", children: _jsx(Text, { bold: true, color: theme.text.primary, children: "Usage left" }) }))] }), _jsx(Box, { borderStyle: "round", borderBottom: true, borderTop: false, borderLeft: false, borderRight: false, borderColor: theme.border.default, width: "100%" }), rows.map((row) => (_jsxs(Box, { children: [_jsx(Box, { width: nameWidth, flexGrow: 1, children: _jsx(Text, { color: theme.text.primary, wrap: "truncate-end", children: row.modelName }) }), _jsx(Box, { width: requestsWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { color: row.isActive ? theme.text.primary : theme.text.secondary, children: row.requests }) }), !showQuotaColumn && (_jsxs(_Fragment, { children: [_jsx(Box, { width: uncachedWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { color: row.isActive ? theme.text.primary : theme.text.secondary, children: row.uncachedTokens }) }), _jsx(Box, { width: cachedWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { color: theme.text.secondary, children: row.cachedTokens }) }), _jsx(Box, { width: outputTokensWidth, flexDirection: "column", alignItems: "flex-end", flexShrink: 0, children: _jsx(Text, { color: row.isActive ? theme.text.primary : theme.text.secondary, children: row.outputTokens }) })] })), _jsx(Box, { width: usageLimitWidth, flexDirection: "column", alignItems: "flex-end", children: row.bucket &&
