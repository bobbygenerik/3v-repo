...
describe('listSessions', () => {
    ...
    it('should display summary as title when available instead of first user message', async () => {
        ...
        expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('1. Add dark mode to the app'));
        expect(consoleLogSpy).not.toHaveBeenCalledWith(expect.stringContaining('How do I add dark mode to my React application'));
    });
});
