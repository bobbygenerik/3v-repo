...
void main() {
  testWidgets('Avatar optimizes memory usage by setting memCache properties', (WidgetTester tester) async {
    ...
    expect(cachedImage.memCacheWidth, equals(expectedCacheSize), reason: 'memCacheWidth should be optimized');
    expect(cachedImage.memCacheHeight, equals(expectedCacheSize), reason: 'memCacheHeight should be optimized');
  });
}
